    ...
    <div class="panel box-shadow-none content-header">
        <div class="panel-body">
            <div class="col-md-12">
                ...
                <p class="animated fadeInDown">CMS<span class="fa-angle-right fa"></span>Client<span class="fa-angle-right fa"></span>Input</p>
            </div>
        </div>
    </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="responsive-table">
                        ...
                        @endif
                    	<form method="POST" action="{{url('/admin/client/input')}}" enctype="multipart/form-data">
						{{ csrf_field() }}
	                        <table class="table">                        
	                            <tr>
                                    <td>Title</td>
