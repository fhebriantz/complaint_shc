...
<div id="content">
    <div class="panel box-shadow-none content-header">
        <div class="panel-body">
            <div class="col-md-12">
                ...
                <p class="animated fadeInDown">CMS<span class="fa-angle-right fa"></span>Address<span class="fa-angle-right fa"></span>Input</p>
            </div>
        </div>
    </div>
    <div class="col-md-12 top-20 padding-0">
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading"><h3>Data Address</h3></div>
                <div class="panel-body">
                    <div class="responsive-table">
                        ...
                        @endif
                    	<form method="POST" action="{{url('/admin/address/input')}}" enctype="multipart/form-data">
						{{ csrf_field() }}
	                        <table class="table">                        
	                            <tr>
                                    <td>Title</td>
                                    <td><textarea class="form-control" id="summernote" rows="5" name="title">{{ old('title') }}</textarea></td>
